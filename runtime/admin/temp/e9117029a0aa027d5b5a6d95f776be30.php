<?php /*a:2:{s:57:"/www/wwwroot/ka1.y9fu.com/app/admin/view/cash/index.phtml";i:1600139160;s:51:"/www/wwwroot/ka1.y9fu.com/app/admin/view/base.phtml";i:1602325784;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="layui-card">
    <div class="layui-card-body">
	    <div class="layui-inline layui-show-xs-block">
			<input type="text" name="username" placeholder="商户ID|订单号" autocomplete="off" class="layui-input">
		</div>
...
<script type="text/html" id="tableTBTrack">
   <div class="layui-btn-group">
		...
		<button type="button" class="layui-btn layui-btn-warm" lay-event="fail">失败</button>
...
<script>
    layui.use(['layer', 'form', 'table', 'util', 'dropdown'], function () {
		...
		var insTb = table.render({
            ...
            cols: [[
                {type:'numbers',title:'#'},
				{field: 'order',align: 'content', sort: true, title: '订单号',width:170},
				...
				{field: 'bankname', align: 'content', title: '账户名称',width:100},
				{field: 'accounts', align: 'content', title: '账户',minWidth:200},
				{field: 'money', align: 'content', title: '金额',width:80},
				{align: 'center',  title: '手续费',field:'price',width:80},
				{align: 'center',  title: '实际到账',templet:'#money',width:100},
				{align: 'center',  title: '状态',field:'status'},
				{align: 'center',  title: '备注',field:'content'},
                {align: 'center', toolbar: '#tableTBTrack', title: '操作',width: 260}
            ]],
		 ...
		 table.on('tool(tableList)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
			...
			switch(layEvent){
				case "bianji":
				  var one=openUrl("审核提现订单",'600px','500px',"<?php echo Url('/Cash/edit'); ?>?id="+data.id);
				break;
				case "fail":
				  layer.confirm('确定执行失败操作，此操作将退回用户金额？', {
						...
						$.ajax({
							url: "<?php echo Url('/Cash/edit'); ?>?type=fail&id="+data.id,
							type: 'post',
							dataType: 'json',
				...
				case "del":
				  layer.confirm('确定删除？', {
						...
						$.ajax({
							url: "<?php echo url('/Cash/del'); ?>?id="+data.id,
							type: 'post',
							dataType: 'json',
							success: function (result) {
								if (result.code === 1) {
