<?php /*a:3:{s:57:"/www/wwwroot/www.ssyd.fun/app/home/view/login/signup.html";i:1600139160;s:57:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/index.html";i:1605435704;s:54:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/to.html";i:1605574982;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
 <head>
  <meta charset="utf-8" />
  ...
  <title><?php echo htmlentities($C['sitename']); ?>-注册账号 </title>
				...
				<div class="register-primary">
					<form action="<?php echo request()->url(); ?>" method="post" id="signup">
						...
						<div class="form-group">
							<label class="control-label" for="username">用户名：</label><input type="text" class="form-control" id="username" name="username" reg="^[A-Za-z0-9_-]{6,20}$" maxlength="20" placeholder="您的帐户名和登录名" null="用户名不能为空" err="用户名格式错误">
							<div class="help-block">
								<span class="onshow"><i class="iconfont"></i>支持字母、数字、“-”“_”的组合，6-20个字符，不支持中文</span>
							</div>
						</div>
						<div class="form-group">
