<?php /*a:3:{s:54:"/www/wwwroot/www.ssyd.fun/app/home/view/index/app.html";i:1600587826;s:57:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/index.html";i:1605435704;s:54:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/to.html";i:1605574982;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
 <head>
  <meta charset="utf-8" />
...
(function() {
 ...
 <li class="" id="navbar-xianxia"><a href="https://www.aixiaoka.net/business.html"><i class="iconfont"></i><span>线下卡回收</span></a></li> 
  ...
  <div class="content app-page">
	<div class="app-focus">
		<div class="container">
			<div class="app-phoneqr png">
				<img src="<?php echo htmlentities((string) $wx['appimg']); ?>" alt="">
			</div>
			<div class="app-download">
				<div class="app-download-item app-download-android">
					<a class="app-btn app-btn-android" href="<?php echo htmlentities((string) (isset($wx['apkurl']) && ($wx['apkurl'] !== '')?$wx['apkurl']:"")); ?>">安卓端下载</a>
					<p>
						版本号：v <?php echo htmlentities((string) (isset($wx['apkv']) && ($wx['apkv'] !== '')?$wx['apkv']:"1.0")); ?>
					</p>
				</div>
				<div class="app-download-item app-download-ios">
					<a class="app-btn app-btn-ios" href="<?php echo htmlentities((string) (isset($wx['isourl']) && ($wx['isourl'] !== '')?$wx['isourl']:"")); ?>">iOS端下载</a>
					<p>
						版本号：v <?php echo htmlentities((string) (isset($wx['isov']) && ($wx['isov'] !== '')?$wx['isov']:"1.0")); ?>
					</p>
				</div>
			</div>
		</div>
	...
	<div class="app-features">
		<div class="container">
			<h2>下载<?php echo htmlentities((string) $C['sitename']); ?><span>手机端</span></h2>
			<ul class="app-features-group clearfix">
				<li>
				...
				<li>
				<div class="features-icon">
					<i class="iconimg iconimg-anys"></i>
				</div>
				<div class="features-desc">
					<h3>快捷</h3>
					<p>
				...
				<li>
				<div class="features-icon">
					<i class="iconimg iconimg-fair"></i>
				</div>
				<div class="features-desc">
					<h3>安全</h3>
					<p>
