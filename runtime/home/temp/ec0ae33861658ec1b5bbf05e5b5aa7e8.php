...
<div class="mycontent" id="mycontent">
	<div class="card-gradient">
		<div class="card">
			...
			<div class="article">
				<p>
					<?php echo htmlentities((string) $C['sitename']); ?>现阶段主要针对保险类、金融类、运营商、航空类、互联网等公司：
				</p>
				<p>
					1、可替员工和客户发放福利；
				</p>
				...
				<br>
				<p>
					随着我司业务种类的不断增加，<?php echo htmlentities((string) $C['sitename']); ?>平台也将诚招符合公司价值观的商家合作，希望能与您一起共筑美好的未来。
				</p>
				<p>
					<strong>企业合作、电商卡、商超卡、话费卡、游戏卡、等多项预付卡合作：</strong>
				</p>
				<p>
					合作电话：<?php echo htmlentities((string) $C['kefu']); ?> <span class="text-light">(08:30-24:00)</span>
				</p>
				<div class="btn-group">
