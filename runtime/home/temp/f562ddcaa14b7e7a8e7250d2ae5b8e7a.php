<?php /*a:4:{s:60:"/www/wwwroot/www.ssyd.fun/app/home/view/index/show_help.html";i:1600587826;s:57:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/index.html";i:1605435704;s:54:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/to.html";i:1605574982;s:58:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/tomenu.html";i:1600587826;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
 <head>
  <meta charset="utf-8" />
  ...
  <title><?php echo htmlentities($C['sitename']); ?>-<?php echo htmlentities($res['title']); ?> </title>
  <meta name="keywords" content="<?php echo htmlentities($res['keywords']); ?>" />
  <meta name="description" content="<?php echo htmlentities($res['description']); ?>" />
	  ...
	  <?php if($i == '1'): ?>
	   ...
	   <?php endif; if(is_array($p) || $p instanceof \think\Collection || $p instanceof \think\Paginator): $k = 0; $__LIST__ = $p;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$k): $mod = ($k % 2 );++$k;?>
		   <dd <?php if($id == $k['id']): ?>class="current"<?php endif; ?>>
			<a href="<?php echo url('home/Helpfaq/danye',['id'=>$k['id']]); ?>"><?php echo htmlentities($k['title']); ?></a>
		   </dd>
