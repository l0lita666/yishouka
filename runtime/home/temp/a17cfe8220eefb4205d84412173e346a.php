<?php /*a:3:{s:65:"/www/wwwroot/www.ssyd.fun/app/home/view/login/forgetpassword.html";i:1600139160;s:57:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/index.html";i:1605435704;s:54:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/to.html";i:1605574982;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
 <head>
  <meta charset="utf-8" />
  ...
  <title><?php echo htmlentities((string) $C['sitename']); ?>-忘记密码 </title>
	...
	<div class="panel panel-bggray">
		  ...
		  <div class="box message-panel">
				<div class="prompt prompt-success">
					...
					<div class="prompt-cont">
						<h4><a id="href" href="<?php echo url('home/index/index'); ?>">重置密码成功！</a>
						</h4>
						<p>
							邮件已经发送到你的绑定邮箱<?php echo tfen($name,3,4); ?>，请尽快登陆修改密码！
						</p>
						<p>
							等待 <strong id="wait">10</strong> 秒后页面自动跳转。如太久没有跳转，
						</p>
						<p>
							您可以手动 <a class="text-blue" href="<?php echo url('home/index/index'); ?>">点击此进入</a>
						</p>
						<div class="action">
							<a class="btn btn-default btn-sm" href="/">返回首页</a>
						</div>
					</div>
				</div>
			</div>
		 ...
		 <div class="box message-panel">
				<div class="prompt prompt-success">
					...
					<div class="prompt-cont">
						...
						<p>
							随机密码已发送到你的手机<?php echo tfen($name,3,4); ?>，请尽快登陆修改密码！
						</p>
						<p>
							等待 <strong id="wait">10</strong> 秒后页面自动跳转。如太久没有跳转，
						</p>
		...
		<?php break; default: ?>
			<div class="box getpass">
				<h2 class="clearfix"><span class="h4 pull-right"><a class="text-blue" href="<?php echo url('home/Login/login'); ?>">返回登录</a></span>找回密码</h2>
				<div class="stepflex stepflex-4 stepflex-primary">
					<ul class="clearfix">
						<li class="doing">
				...
				<form action="<?php echo request()->url(); ?>" method="post" id="forgetpassword">
					<div class="form-group">
						...
						<div class="col-xs-5">
							<div class="mr4">
								<input class="form-control" id="username" name="username" type="text" placeholder="用户名/邮箱/手机号码" null="请输入用户名/邮箱/手机号码">
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-xs-3">
							<div class="mr4">
								<input type="text" class="form-control" id="codeno" name="codeno" maxlength="5" null="请输入验证码">
							</div>
						</div>
					...
					<div class="form-group pb30">
						<div class="col-xs-5 col-xs-offset-4">
							...
							<button class="btn btn-primary btn-block" type="button" data-form="top-left,json" id="signupbtn" name="forgetpassword">确认找回</button>
						</div>
					</div>
				</form>
			</div>
