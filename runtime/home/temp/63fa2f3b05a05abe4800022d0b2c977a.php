<?php /*a:5:{s:60:"/www/wwwroot/www.ssyd.fun/app/home/view/account/alireal.html";i:1600139160;s:58:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/member.html";i:1605574940;s:54:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/to.html";i:1605574982;s:61:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/user_menu.html";i:1605547434;s:61:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/info_menu.html";i:1600587826;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
 <head>
  <meta charset="utf-8" />
	...
	<div class="modal-prompt">
		<div class="prompt prompt-warning">
			...
			<div class="prompt-cont">
				<h4>请实名认证</h4>
				<p>
					为了有效保障您的<?php echo htmlentities((string) $C['sitename']); ?>账户的资金安全，实名认证之后才可以提现哦！
				</p>
				<div class="action">
   ...
   <div class="navbar " id="navbar" data-navbar="">
    <div class="container-fluid">
     <div class="navbar-brand" id="logo">
      <a href="/"><span class="logo"><img src="<?php echo htmlentities((string) $C['logo']); ?>" alt="<?php echo htmlentities((string) $C['sitename']); ?>" style="display:block;margin: auto;" /></span></a>
     </div>
   ...
   <li class="" id="navbar-app" data-hover="dropdown"><a href="<?php echo url('home/index/app'); ?>"><i class="iconfont"></i><span>下载APP</span></a>
    <div class="dropdown-menu animated zoomIn">
     <div class="navbar-download"> 
      <h5>手机回收方便快捷</h5> 
      <img src="<?php echo htmlentities((string) $C['appimg']); ?>" alt="" /> 
      <p>扫码下载卡卡APP</p>
     </div>
    </div></li>
	<?php endif; ?>
...
<div class="view-framework">
    ...
    <div class="sidebar-body">
     ...
     <div class="sidebar-functional">
      <a href="tencent://message/?uin=<?php echo htmlentities((string) $C['qq']); ?>&Site=QQ交谈&Menu=yes"><i class="iconimg iconimg-qq">在线咨询</i></a>
     </div>
...
<div class="view-framework-main">
    <ul class="nav-tabs clearfix">
      <li <?php if(($action == 'profile')): ?> class="current"<?php endif; ?>><a href="<?php echo url('home/Member/profile'); ?>">基本资料</a></li>
      <li <?php if(($contr == 'Account' || $action=='realname')): ?> class="current"<?php endif; ?>><a href="<?php echo url('home/Member/realname'); ?>">实名认证</a></li>
      <li <?php if(($contr == 'Editpass' || $action=='password' || $action=='paymentcodepin')): ?>class="current"<?php endif; ?>><a href="<?php echo url('home/Member/password'); ?>">密码管理</a></li>
      <li <?php if(($contr == 'Mobile' || $action=='photo')): ?>class="current"<?php endif; ?>><a href="<?php echo url('home/Member/photo'); ?>">手机设置</a></li>
      <li <?php if(($contr == 'Email' || $action=='email')): ?>class="current"<?php endif; ?>><a href="<?php echo url('home/Member/email'); ?>">邮箱设置</a></li>
      <li <?php if(($action=='setcash' || $action=='alipay' || $action=='weixin')): ?>class="current"<?php endif; ?>><a href="<?php echo url('home/Member/setcash'); ?>">提现账号</a></li>
     </ul>
    <div class="box tab-content realname-content">
        <div class="alert alert-icon alert-warning hidden">
            ...
            <div class="text">
                ...
                <p>实名认证：是由<?php echo htmlentities((string) $C['sitename']); ?>提供的一项身份识别服务，只有实名认证之后才可进行余额提现操作。</p>
            </div>
        </div>
            ...
            <div class="userform userform-narrow">
                <div class="form-group mb20">
                    ...
                    <div class="form-element">
                        <ul class="btn-group btn-group-long clearfix" id="realname-group">
                             <?php if($isapi == '1'): ?>
                            <li class="active">
                                <a class="btn" href="<?php echo url('home/Account/index'); ?>">
                                    <i class="iconfont iconfont-alipay">&#xe637;</i>使用支付宝实名认证(自动)</a>
                            </li>
                            
                            <li class="divider">
                                <span class="text-light">或</span></li><?php endif; ?>
                            <li>
                                <a class="btn" href="<?php echo url('home/Account/actrealname'); ?>">
                                    <i class="iconfont iconfont-identity">&#xe674;</i>上传身份证实名认证(人工)</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="realname-tabs">
                    <div class="form-group-btn pt10 clearfix">
                        ...
                        <input class="btn btn-green make-alipay pull-left" type="button" id="anjian" data-form="top-left,json" name="uploadImage" value="开始认证" /></div>
                </div>
            </div>
        </form>
    </div>
		...
		<div class="footer footer-sm">
			<div class="text-center">
				...
				<?php if(is_array($thisli) || $thisli instanceof \think\Collection || $thisli instanceof \think\Paginator): $i = 0; $__LIST__ = $thisli;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?>
					<a href="<?php echo url('home/Helpfaq/danye',['id'=>$p['id']]); ?>" target="_blank"><?php echo htmlentities((string) $p['title']); ?></a><span class="sep">|</span>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</p>
		...
		<dl class="toolbar" id="toolbar">
			...
			<div class="dropdown-menu dropdown-menu-weixin animated fadeInRight">
				<img src="<?php echo htmlentities((string) $wx['wxewm']); ?>" alt="">
				<p class="text-light h6">
					扫码关注微信公众号
				</p>
			</div>
