<?php /*a:4:{s:59:"/www/wwwroot/www.ssyd.fun/app/home/view/index/feedback.html";i:1604081102;s:57:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/index.html";i:1605435704;s:54:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/to.html";i:1605574982;s:58:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/tomenu.html";i:1600587826;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
 <head>
  <meta charset="utf-8" />
  ...
  <title><?php echo htmlentities((string) $C['sitename']); ?>-<?php echo htmlentities((string) $res['title']); ?> </title>
	...
	<div class="help-cont">
		<form method="post" id="feedbackbtn" action="?">
			<div class="alert alert-warning">
				<p class="h5">
					如果您在使用本平台过程中遇到问题Bug，或者有更好的意见建议，欢迎留言，感谢您对爱销卡的支持；<br>
			...
			<div class="form-group">
				...
				<?php echo token_field(); ?>
					<button class="btn btn-green btn-lg btn-block" type="button" id="anjian" name="feedbackbtn" data-form="top-left,json">提交反馈</button>
				</div>
			</div>
		</form>
	</div>
