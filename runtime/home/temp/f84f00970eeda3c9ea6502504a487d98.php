<?php /*a:2:{s:59:"/www/wwwroot/www.ssyd.fun/app/home/view/cash/wap/index.html";i:1606274178;s:60:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/wap/tou2.html";i:1602249776;}*/ ?>
 <html lang="zh-cn">
<head>
<meta charset="utf-8">
	...
	<div class="myfixed">
		<div class="tabs navbar navbar-inverse">
		 <?php if($pei['alitype'] == '1'): ?>
			<a class="tab-item active" href="<?php echo url('home/Cash/index'); ?>"><span>提现至支付宝</span></a><?php endif; if($pei['banktype'] == '1'): ?>
			<a class="tab-item" href="<?php echo url('home/Cash/bank'); ?>"><span>提现至银行卡</span></a><?php endif; if($pei['wxtype'] == '1'): ?>
		...
		<form action="<?php echo url('home/Cash/withdraw'); ?>" method="post" id="formbtn">
			<div class="card">
				<div class="alert alert-alt alert-danger text-center" style="margin-bottom: 0; ">
					推荐支付宝提现，<?php if($pei['alifeilv'] == '0'): ?>免手续费，实时到账<?php else: if($pei['alifeilv'] > '0.99'): ?>每笔手续费<?php echo htmlentities($pei['alifeilv']); ?>元<?php else: ?>每笔手续费<?php echo htmlentities($pei['alifeilv']); ?>%<?php endif; ?><?php endif; ?>
				</div>
				...
				<div class="cashlist" id="cashlist">
					...
					<div class="cell-hd">
						<img class="img-36" src="/static/home/images/banks/alipay.png" alt="">
					</div>
					<div class="cell-bd">
						<h5 class="text-gray">支付宝</h5>
						<p>
							<?php echo tfen($p['accounts'],3,7); ?>
						</p>
					</div>
					<div class="cell-ft">
				...
				<div class="card-footer">
					<div class="cell">
						<div class="cell-bd">
							<p class="text-light h5" data-dialog="<?php echo url('home/Bank/addalipay'); ?>,600,添加支付宝">
								<i class="plus"></i> 添加支付宝帐号
							</p>
						</div>
						<div class="cell-ft">
							<a class="text-blue" href="<?php echo url('home/Member/alipay'); ?>">管理</a>
						</div>
					</div>
				</div>
			</div>
			<div class="card">
				<div class="cell cash-primary">
					...
					<div class="cell-bd">
						<input class="form-control form-control-error" name="moneyoff" placeholder="输入提现金额" id="moneyoff" type="number" value="" num="0|0.00" maxlength="8" null="请输入要提现的金额" reg="^\d+(\.\d+)?$" >
					</div>
					<div class="cell-ft">
...
<div class="tooltip top-left tooltip-error" id="tooltip" style="left: 85px; top: 270px; display: none;">
