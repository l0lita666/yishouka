<?php /*a:5:{s:56:"/www/wwwroot/www.ssyd.fun/app/home/view/index/index.html";i:1606211444;s:57:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/index.html";i:1605435704;s:54:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/to.html";i:1605574982;s:63:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/home_buttom.html";i:1600587826;s:60:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/home_wen.html";i:1606023322;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
 <head>
  <meta charset="utf-8" />
...
#silderto .owl-buttons > .owl-prev{
    left: 0px; 
}
#silderto .owl-buttons > .owl-next{
    right: 0px;
}
</style>
  <div class="content">
   <div class="jumbotron" style="padding:0">
    <div class="" id="silderto">
        <?php $_result=get_link(12,'desc');if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?>
     <div class="masthead" style="height:100%">
     <a href="<?php echo htmlentities($p['url']); ?>"> <img  style="margin-top:0;" src="<?php echo htmlentities($p['image']); ?>" alt=""  /></a>
     </div>
     <?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
   </div>
   <script type="text/javascript" src="/static/home/js/owl.carousel.min.js"></script>
     <script>$("#silderto").owlCarousel({autoPlay:5000,paginationSpeed:1200,singleItem:true,scrollPerPage: true,paginationNumbers:true,navigation: true,navigationText : ["<i class='iconfont'>&#xe638;</i>", "<i class='iconfont'>&#xe629;</i>"],});</script>
   <div class="panel panel-stepflow ">
    <div class="container">
     <div class="kaka-notice">
      ...
      <div class="kaka-notice-text">
       ...
       <a href="<?php echo url('home/helpfaq/index'); ?>" target="_blank" title="<?php echo htmlentities($new['title']); ?>"><?php echo htmlspecialchars_decode($new['content']); ?></a>
      </div> 
     ...
     <div class="kaka-stepflows">
      ...
      <div class="num">
       <?php echo htmlentities($f['d_user']); ?>
      </div></li>
     <li>
      <div class="flow">
       登录爱销卡账户
     ...
     <li>
      ...
      <div class="num">
       <?php echo htmlentities($f['card_count']); ?>
      </div></li>
     <li>
      <div class="flow">
       绑定提现账号
     ...
     <li>
      ...
      <div class="num">
       <?php echo htmlentities($f['d_card_count']); ?>
      </div></li>
     <li>
      <div class="flow">
       等待平台验卡
     ...
     <li>
      ...
      <div class="num">
       <?php echo htmlentities($f['d_secc_count']); ?>
      </div> </li>
     <li>
      <div class="flow">
       相应资金到账
     ...
     <li>
      ...
      <div class="num">
       <?php echo htmlentities($f['day_draw']); ?>
      </div></li>
     <li>
      <div class="flow">
       银行或支付宝
     ...
     <li>
      ...
      <div class="num">
       <?php echo htmlentities($f['wait_card_number']); ?>
      </div></li>
      </ul>
     </div>
    </div>
   ...
   <div class="panel panel-what">
    <div class="container">
     <div class="panel-heading">
      <h3 class="panel-title"><?php echo htmlentities($C['sitename']); ?>能做什么？</h3>
      <div class="panel-subtitle">
       <p>优质的服务让您的每一笔交易都放心满意</p>
      </div>
     </div>
     <div class="panel-body">
      <ul class="what-group clearfix">
       <li>
        <div class="what-group-inner">
         <i class="iconimg iconimg-1"></i>
         <h5>解决浪费</h5>
         <p><?php echo htmlentities($C['sitename']); ?>直接面对用户回收，足不出户即可提交卡号卡密完成回收交易，解决每年上十亿礼品卡闲置的问题。</p>
        </div></li>
       <li>
        <div class="what-group-inner">
         <i class="iconimg iconimg-2"></i>
         <h5>资金回流</h5>
         <p><?php echo htmlentities($C['sitename']); ?>让企业置闲、员工福利、亲友相赠等方式获取的礼品卡快速变现，以达到资金回流最大化。</p>
        </div></li>
       <li class="last">
        <div class="what-group-inner">
         <i class="iconimg iconimg-3"></i>
         <h5>交易多样</h5>
         <p><?php echo htmlentities($C['sitename']); ?>提供线上回收、线下交易、API接口等多种交易方式，还可以根据用户自由定制交易方式。</p>
        </div></li>
      </ul>
     </div>
    </div>
   </div>
   <div class="panel panel-bggray panel-feature">
    <div class="container">
     <div class="panel-heading">
      <h3 class="panel-title">为什么要选择<?php echo htmlentities($C['sitename']); ?>？</h3>
      <div class="panel-subtitle">
       <p>我们是专业的卡券服务平台</p>
      </div>
     </div>
      ...
      <ul class="feature-group clearfix">
       <li>
        <div class="feature-type">
         <i class="iconimg iconimg-type"></i>
         <h5>丰富</h5>
         <p>支持丰富回收多样</p>
        </div> </li>
       <li> 
        <div class="feature-heart">
         <i class="iconimg iconimg-heart"></i>
         <h5>用心</h5>
         <p>一对一的用心服务</p>
        </div> </li>
       <li>
        <div class="feature-safe"> 
         <i class="iconimg iconimg-safe"></i>
         <h5>保证</h5>
         <p>人工处理品牌保证</p>
        </div> </li>
       <li>
        <div class="feature-fast"> 
         <i class="iconimg iconimg-fast"></i>
         <h5>极速</h5>
         <p>处理快捷汇款极速</p>
        </div> </li>
       <li>
        <div class="feature-price"> 
         <i class="iconimg iconimg-price"></i>
         <h5>高价</h5>
         <p>价格公道让您满意</p>
        </div> </li>
      </ul>
