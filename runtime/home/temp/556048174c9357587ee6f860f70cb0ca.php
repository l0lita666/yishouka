...
<div class="mycontent" id="mycontent">
	<div class="card-gradient">
		<div class="card">
			...
			<div class="article">
				<p>
					<?php echo htmlentities($C['sitename']); ?>属于安徽邦麦客网络科技有限公司，是运营关于二手卡回收服务的网站，公司成立以来一直致力于卡回收、卡兑换、卡消费、卡资讯服务等业务的合作和拓展。
				</p>
				<p>
					目前，<?php echo htmlentities($C['sitename']); ?>暂时只针对网站公布回收的卡进行回收处理。
				</p>
			</div>
		</div>
		<div class="card">
			...
			<div class="article">
				...
				<div class="btn-group">
					...
					<a class="btn btn-primary" href="http://wpa.qq.com/msgrd?v=3&amp;uin=<?php echo htmlentities($C['qq']); ?>&amp;site=qq&amp;menu=yes" rel="external nofollow">在线QQ咨询</a>
				</div>
			</div>
		</div>
	</div>
