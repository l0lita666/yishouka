<?php /*a:3:{s:61:"/www/wwwroot/www.ssyd.fun/app/home/view/helpfaq/business.html";i:1605435620;s:57:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/index.html";i:1605435704;s:54:"/www/wwwroot/www.ssyd.fun/app/home/view/layout/to.html";i:1605574982;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
 <head>
  <meta charset="utf-8" />
...
<div class="content">
	<div class="business-jumbotron">
	</div>
	<div class="panel">
		<div class="panel-heading">
			<h3 class="panel-title">线下回收/大客户/招商合作联系方式</h3>
			<div class="panel-subtitle">
				<s class="line"></s>
				<p class="h3">
					针对游戏公会，渠道客户等各类商家招商合作、线下回收
				</p>
			</div>
		</div>
		<div class="container">
			<div class="business clearfix">
			<?php if(is_array($cardModel) || $cardModel instanceof \think\Collection || $cardModel instanceof \think\Paginator): $l = 0; $__LIST__ = $cardModel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$k): $mod = ($l % 2 );++$l;if($k['status'] == '1'): ?>
				<div class="business-item">
					<div class="business-body">
						<h3><?php echo htmlentities((string) $k['title']); ?>招商</h3>
						<div class="business-carousel owl-carousel owl-theme" >
							
								   <div class="owl-item" >
									<ul class="business-cards clearfix">
									 <?php if(is_array($k['comments']) || $k['comments'] instanceof \think\Collection || $k['comments'] instanceof \think\Paginator): $i = 0; $__LIST__ = $k['comments'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?>
											<li>
												<div class="business-cards-item">
													<img src="<?php echo htmlentities((string) $p['iconurl']); ?>" alt="<?php echo htmlentities((string) $p['title']); ?>" title="<?php echo htmlentities((string) $p['title']); ?>">
						...
						<?php switch($l): case "1": ?>
								<a class="btn btn-green" href="tencent://message/?uin=<?php echo htmlentities((string) $C['qq']); ?>&Site=QQ交谈&Menu=yes" target="_blank"><i class="iconfont"></i> QQ交谈</a>
							<?php break; case "2": ?>
								<a class="btn btn-primary" href="tencent://message/?uin=<?php echo htmlentities((string) $C['qq']); ?>&Site=QQ交谈&Menu=yes" target="_blank"><i class="iconfont"></i> QQ交谈</a>
							<?php break; case "3": ?>
								<a class="btn btn-red" href="tencent://message/?uin=<?php echo htmlentities((string) $C['qq']); ?>&Site=QQ交谈&Menu=yes" target="_blank"><i class="iconfont"></i> QQ交谈</a>
							<?php break; case "4": ?>
								<a class="btn btn-green" href="tencent://message/?uin=<?php echo htmlentities((string) $C['qq']); ?>&Site=QQ交谈&Menu=yes" target="_blank"><i class="iconfont"></i> QQ交谈</a>
							<?php break; case "5": ?>
								<a class="btn btn-orange" href="tencent://message/?uin=<?php echo htmlentities((string) $C['qq']); ?>&Site=QQ交谈&Menu=yes" target="_blank"><i class="iconfont"></i> QQ交谈</a>
							<?php break; case "6": ?>
								<a class="btn btn-primarybtn" href="tencent://message/?uin=<?php echo htmlentities((string) $C['qq']); ?>&Site=QQ交谈&Menu=yes" target="_blank"><i class="iconfont"></i> QQ交谈</a>
							<?php break; case "7": ?>
								<a class="btn btn-red" href="tencent://message/?uin=<?php echo htmlentities((string) $C['qq']); ?>&Site=QQ交谈&Menu=yes" target="_blank"><i class="iconfont"></i> QQ交谈</a>
							<?php break; ?>
						<?php endswitch; ?>
